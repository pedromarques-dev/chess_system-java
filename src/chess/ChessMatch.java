...
public class ChessMatch {
    ...
    private ChessPiece king(Color color) {
        List<Piece> list = piecesOnTheBoard.stream().filter(piece ->  piece.getColor() == color).collect(Collectors.toList());
        for (Piece p : list) {
    ...
    private boolean testCheck(Color color) {
        ...
        List<Piece> opponentPieces = piecesOnTheBoard.stream().filter(piece ->  piece.getColor() == opponent(color)).collect(Collectors.toList());
